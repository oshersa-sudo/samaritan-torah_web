...
PERFORMERS = {
    ...
    # not the same man as הכהן נתנאל בן אברהם — different father, kept apart
    'הכהן נתנאל בן פינחס':     ['הכהן אבו עאבד', 'אבו עאבד', 'aaed alkahen',
                               'abu abed'],
    'הכהן ברית בן טביה':       ['הכהן ברית', 'ברית כהן', 'ברית בן טביה', 'ברית'],
    'עדן כהן':                [],
    'תקי כהן':                ['תופיק כהן ( אבו תקי)', 'תופיק כהן', 'אבו תקי'],
    'הכהן הגדול מצליח (תאופיק) בן אשר': ['הכהן תופיק (אבו ראלב)',
                                        'הכהן תופיק ( אבו ראלב)', 'אבו ראלב'],
    'נתן יהושע':              [],
    'ארז יהושע':              [],
    'נתן וארז יהושע':          [],
    'אושר ששוני':             ['אושר'],
