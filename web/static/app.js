...
const I18N = {
  ...
  ar: {
    ...
    more_results:'نتائج إضافية', phr_occurrences:'مواضع', phr_words:'كلمات التعبير', phr_head:'تعابير ثابتة', phr_formula:'لقب ثابت', phr_idiom:'تعبير اصطلاحي', mean_head:'معنى الكلمة', mean_memar:'حسب الترجمة العبرية لميمر مرقة', mean_torah:'حسب معجم كلمات التوراة', mean_clash:'المداخل أدناه تخصّ الجذر لا هذه الكلمة', sug_head:'اقتراح من الاشتقاق', sug_note:'غير مؤكَّد مقابل المعجم أو مرقة أو التوراة — لا يُعطى جذر', ver_by:'مؤكَّد بواسطة', infl_head:'تحليل الصيغة', infl_deriv:'الاشتقاق', infl_marqe:'حسب الترجمة العبرية لميمر مرقة', infl_review:'اقتراح — بحاجة إلى تأكيد', tal_meaning:'المعنى من المعجم', tal_torah:'المواضع في التوراة', tal_forms:'صيغ ومداخل إضافية', tal_page:'ص', tal_none:'لم يُعثر على مدخل لهذه الكلمة في المعجم.', tal_click_precise:'اضغط للمدخل الدقيق من المعجم ⬅',
...
async function showTalFull(word){
  ...
  if(mn){
    ...
    box.appendChild(el('div','note', t(mn.source==='memar'?'mean_memar':'mean_torah')));
