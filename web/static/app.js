...
const I18N = {
  he: {
    ...
    whatsnew_pages:[
      '<p><b>גרסה 3.1 — אישי השומרונים, ומדף ספרים חדש</b></p><ul><li><b>אישי השומרונים</b> נוסף לספרייה כיחידה עצמאית: 95 דמויות — מאהרן הכהן ובאבא רבה, דרך פייטני ימי הביניים, ועד בני העדה וחוקריה במאה העשרים — ולכל אחת הסבר על מקומה במסורת</li><li>הרשימה נפרשת <b>לפי תקופה</b> או <b>לפי א״ב</b>, והחיפוש רץ גם על גוף ההסברים — כך שאפשר למצוא אישיות לפי עניין ולא רק לפי שמה</li><li>ל-23 מן האישים נוספה <b>הרחבה</b> — תאריכים, תיקונים והקשר שאין בערך עצמו — ולצדה <b>לקריאה נוספת</b>; ושמותיהם העבריים הובאו במקום הצורה הערבית היכן שהם ידועים</li><li>מדף הספרים עוצב מחדש: שם הספר כתוב על הכריכה עצמה, לכל ספר צבע משלו, והכריכות הוקטנו — כך נכנסים בשורה אחת כפליים ספרים מקודם</li></ul>',
